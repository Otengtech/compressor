...
import { Star, ThumbsUp, MessageSquare, Send, User, Mail, Calendar } from "lucide-react";
...
const ReviewPage = () => {
  ...
  const ratingDistribution = Array(5).fill(0).map((_, i) => ({
    ...
    percentage: totalReviews > 0 ? (allReviews.filter(r => r.rating === (5 - i)).length / totalReviews * 100) : 0
  }));
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-lime-50">
      ...
      <section className="bg-gray-900 py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 lg:px-16 text-center">
          <h1 ref={titleRef} className="scroll-reveal opacity-0 translate-y-8 text-4xl lg:text-5xl font-bold text-white mb-4">
            Customer Reviews
          </h1>
        ...
        <div className="max-w-7xl mx-auto lg:px-16">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div ref={featuredRef} className="scroll-reveal opacity-0 translate-y-8 bg-white rounded-3xl p-4 shadow-lg mb-8">
                ...
                <div className="bg-lime-50 rounded-2xl p-8">
                  {/* Quote */}
                  <div className="mb-6">
                    <svg className="w-12 h-12 text-lime-300" fill="currentColor" viewBox="0 0 32 32">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-gray-600 ml-2">{featuredReview.rating}.0</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-16 h-16 rounded-full overflow-hidden bg-lime-100 border-4 border-white">
                          {featuredReview.avatar ? (
                            <img src={featuredReview.avatar} alt="" className="w-full h-full object-cover" />
                          ) : (
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 text-lg">{featuredReview.name}</h3>
                ...
                <div className="flex justify-center items-center gap-4 mt-6">
                  <button onClick={handlePrev} className="p-3 rounded-full bg-lime-100 hover:bg-lime-200">
                  ...
                  <button onClick={handleNext} className="p-3 rounded-full bg-lime-100 hover:bg-lime-200">
                    <svg className="w-6 h-6 text-lime-600" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
              ...
              {/* All Reviews List */}
              <div ref={listRef} className="scroll-reveal hidden md:block opacity-0 translate-y-8 bg-white rounded-3xl p-8 shadow-lg">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                  <h2 className="text-2xl font-bold text-gray-900">All Reviews ({allReviews.length})</h2>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg sticky top-8">
                ...
                <form onSubmit={handleSubmitReview} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        ...
                        >
                          <Star className={`w-6 h-6 ${newReview.rating >= star ? 'fill-yellow-400' : ''}`} />
                        </button>
                      ))}
                  ...
                  <button
                    ...
                    className={`w-full bg-gradient-to-r from-lime-400 to-lime-500 text-white py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg flex items-center justify-center ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
                    {isSubmitting ? (
